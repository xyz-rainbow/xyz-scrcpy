...
| [`docs/internal/plan-linux-installer-parity.md`](plan-linux-installer-parity.md) | Status section, restored `## Feature parity matrix`, Phase 5/Verification wording. |
...
- [plan-linux-installer-parity.md](plan-linux-installer-parity.md) (this folder)
- [README.md](../README.md)
