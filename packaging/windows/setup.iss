...
Source: "..\..\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; \
  Excludes: "\.git\*,\.github\*,\.venv\*,\dist\*,\build\*,__pycache__\*,*.pyc,\.cursor\*,\.claude\*,\.pytest_cache\*,\.mypy_cache\*,\.ruff_cache\*,agent-transcripts\*,mcps\*,scripts\*,docs\internal\*,packaging\windows\app.ico,config\*.log,config\*.json"
