...
from xyz_scrcpy import vendor_bootstrap as vb  # noqa: E402, I001

_MOD = "xyz_scrcpy.vendor_bootstrap"
_ADB_MOD = "xyz_scrcpy.adb_resolve"
...
class VendorBootstrapTests(unittest.TestCase):
    ...
    def test_verify_tools_resolved_vendor_adb(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            with (
                patch(f"{_ADB_MOD}.shutil.which", return_value=None),
    ...
    def test_extract_scrcpy_tar_replaces_broken_vendor_binary(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            with (
                patch(f"{_MOD}.tarfile.open", return_value=FakeTar()),
    ...
    def test_ensure_android_tools_skip_download_runs_manual_when_missing(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            with (
                patch(f"{_ADB_MOD}._platform_tools_candidates", return_value=[]),
